 ...
 * ```
 */
let ClientDataTable = class ClientDataTable extends LitElement {
    constructor() {
        super(...arguments);
        this.apiEndpoint = '';
        this.columns = [];
    ...
    async loadData() {
        ...
        if (this.data.length > 100) {
            console.debug(`[client-data-table] Loaded ${this.data.length} rows in ${loadTime.toFixed(2)}ms, ` +
        ...
        <table>
          ...
          <tbody>
            ...
            ? html `
                ...
                `
            : repeat(this.paginatedData, (row) => row.id || JSON.stringify(row), (row) => html `
                    <tr>
                      ${this.columns.map((column) => html `
...
], ClientDataTable.prototype, "apiEndpoint", void 0);
__decorate([
    property({ type: Array })
], ClientDataTable.prototype, "columns", void 0);
__decorate([
    property({ type: Number, attribute: 'page-size' })
], ClientDataTable.prototype, "pageSize", void 0);
__decorate([
    property({ type: String, attribute: 'empty-message' })
], ClientDataTable.prototype, "emptyMessage", void 0);
__decorate([
    property({ type: Object })
], ClientDataTable.prototype, "filters", void 0);
__decorate([
    state()
], ClientDataTable.prototype, "data", void 0);
__decorate([
    state()
], ClientDataTable.prototype, "filteredData", void 0);
__decorate([
    state()
], ClientDataTable.prototype, "loading", void 0);
__decorate([
    state()
], ClientDataTable.prototype, "error", void 0);
__decorate([
    state()
], ClientDataTable.prototype, "searchQuery", void 0);
__decorate([
    state()
], ClientDataTable.prototype, "sortConfig", void 0);
__decorate([
    state()
], ClientDataTable.prototype, "currentPage", void 0);
ClientDataTable = __decorate([
    customElement('client-data-table')
], ClientDataTable);
export { ClientDataTable };
//# sourceMappingURL=client-data-table.js.map