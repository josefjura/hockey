...
export default function TeamEditDialog({ isOpen, onClose, team }: TeamEditDialogProps) {
  ...
  const previewName = watchedValues.name || 'National Team'
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
            <div>
              ...
              <input
                ...
                id="name"
                {...register('name')}
                placeholder="Leave empty for national team"
            ...
            <div>
              ...
              <select
                ...
                disabled={updateTeamMutation.isPending || countriesLoading}
              >
            ...
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
              ...
              <div className="text-sm text-gray-600">
                <p><strong>Team:</strong> {previewName}</p>
            ...
            <div className="flex items-center space-x-3 pt-4">
              <button
                type="submit"
                disabled={!isValid || updateTeamMutation.isPending}
