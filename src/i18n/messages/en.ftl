...
player-scoring-total-assists = Total Assists
player-scoring-total-points = Total Points
player-scoring-identified = identified
player-scoring-unidentified = unidentified
player-scoring-filter-event-type = Event Type
player-scoring-filter-season = Season
player-scoring-filter-team = Team
player-scoring-filter-date-from = From Date
player-scoring-filter-date-to = To Date
player-scoring-all-events = All Events
player-scoring-goals-only = Goals Only
player-scoring-assists-only = Assists Only
player-scoring-all-seasons = All Seasons
player-scoring-all-teams = All Teams
player-scoring-date = Date
player-scoring-match = Match
player-scoring-event-type = Type
player-scoring-team = Team
player-scoring-period = Period
player-scoring-time = Time
player-scoring-goal-type = Goal Type
player-scoring-details = Details
player-scoring-scorer = Scorer
player-scoring-assist-1 = Assist 1
player-scoring-assist-2 = Assist 2
player-scoring-goal = Goal
player-scoring-assist-primary = Primary Assist
player-scoring-assist-secondary = Secondary Assist
player-scoring-even-strength = Even Strength
player-scoring-power-play = Power Play
player-scoring-short-handed = Short Handed
player-scoring-penalty-shot = Penalty Shot
player-scoring-empty-net = Empty Net
player-scoring-empty-title = No Scoring Events
